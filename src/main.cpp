...
const string strMessageMagic = "erso Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "erso", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.com/news/business-38587625";
        CTransaction txNew;
        txNew.nTime = 1484150789;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1484150789;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 18503440;
        ...
        assert(block.hashMerkleRoot == uint256("0x97fdb6b292f76cd10341764f4664e93d49e05de9167a91246faeba11d40bbc3c"));
