...
private slots:
    ...
    void on_Buyerso_clicked();
    void on_SellersoBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputerso_textChanged(const QString &arg1);
    ...
    QString Buyerso(QString OrderType, double Quantity, double Rate);
    QString Sellerso(QString OrderType, double Quantity, double Rate);
